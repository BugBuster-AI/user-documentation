...
3. Видео прохождения появляется позже и гарантированно сохраняется. Чтобы просмотреть его, перейдите по ссылке **View video result**.
...
2. Выберите:
   ...
   -  **Environment** (браузер, ОС, разрешение экрана). [Узнать больше о настройке окружения](../../04-peremennye-i-okruzheniya/nastroyka-okruzheniya).

   -  **Параллельные потоки (стримы)**. Количество потоков зависит от тарифа. [Узнать больше о работе с потоками](../../04-peremennye-i-okruzheniya/rabota-s-potokami).
...
Доступна остановка **Test Run** одной кнопкой.
