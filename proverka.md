...
Система анализирует скриншот и проверяет, соответствует ли он вашему описанию. Если элемент не найден, тест падает. Если шаг не содержит четкого описания действия, выдается ошибка. Некорректные команды блокируются.
...
Система всегда выдает бинарный результат. После проверки система добавляет объяснение своего решения -- почему проверка сработала или не сработала -- на том же языке, на котором написана проверка:
